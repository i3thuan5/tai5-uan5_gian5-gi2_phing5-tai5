...
class 平臺項目表(models.Model):
	項目名 = '平臺項目'
	外語 = models.ForeignKey(外語表, related_name=項目名)
	影音 = models.ForeignKey(影音表, related_name=項目名)
	文本 = models.ForeignKey(文本表, related_name=項目名)
	聽拍 = models.ForeignKey(聽拍表, related_name=項目名)
